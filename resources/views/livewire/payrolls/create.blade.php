    ...
    <div
        ...
        <div class="p-2">
            <div class="space-y-0.5">
                <h2 class="text-xl font-semibold tracking-tight dark:text-zinc-100">{{ $this->payroll ? 'Update Payroll' : 'Tambah Payroll' }}</h2>
                <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ $payroll->karyawan->name ?? null }}</p>
            </div>
        </div>
    </div>
